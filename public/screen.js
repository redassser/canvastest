    ...
    return (
        <>
            ...
            <input className="inp" type="number" value={seedc} onChange={(x)=>{seedChange(x.target.value)}}/>
                ...
                <input className="inp" name="choose" type="radio" id="noise" onChange={(x)=>{if(x.target.value==="on")chooChange(0);}}/> <label className="inp" htmlFor="noise">Simplex Archipelago</label>
                <input className="inp" name="choose" type="radio" id="perlin" onChange={(x)=>{if(x.target.value==="on")chooChange(1);}} defaultChecked/> <label className="inp" htmlFor="perlin">Image Greyscale</label>
            </div>
